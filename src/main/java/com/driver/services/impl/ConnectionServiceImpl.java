...
public class ConnectionServiceImpl implements ConnectionService {
    ...
    public User connect(int userId, String countryName) throws Exception{
        ...
        if(user.getMarkedIp()!=null)
            ...
            if(serviceProvider1!=null){
                ...
                user.setMarkedIp(masked);
                user.setConnected(true);
                user.getConnectionList().add((java.sql.Connection) connection);

                serviceProvider1.getConncectionList().add(connection);
    ...
    public User communicate(int senderId, int receiverId) throws Exception {
        ...
        if(receiver.getMarkedIp()!=null){
            String Ip = receiver.getMarkedIp();
